...
function selectTopicCard(cat) {
  ...
  document.querySelectorAll('.topic-pill').forEach(card => {
    card.classList.toggle('active', card.dataset.topic === cat);
  });
...
function resetFilters() {
  ...
  if (elements.difficultyFilter) elements.difficultyFilter.value = 'all';
